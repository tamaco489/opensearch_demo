...
resource "aws_route53_record" "opensearch_demo_apiv1" {
  ...
  alias {
    name                   = aws_apigatewayv2_domain_name.opensearch_demo_apiv1.domain_name_configuration.0.target_domain_name
    zone_id                = aws_apigatewayv2_domain_name.opensearch_demo_apiv1.domain_name_configuration.0.hosted_zone_id
